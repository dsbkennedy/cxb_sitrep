...
* There have been **`r cases_week[2]`** new cases in the FDMN/Rohingya Refugee population in week `r ThisWeek`. In week (week `r LastWeek`) there were  **`r cases_week[1]`** cases.
